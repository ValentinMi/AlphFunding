...
AlphPool is a decentralized crowdfunding platform built on Alephium blockchain, it allows you to create a pool and collect donations from the community.
...
AlphPool provides a **simple form** where you can specify your pool properties,
