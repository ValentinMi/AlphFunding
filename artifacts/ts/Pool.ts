...
export const Pool = new Factory(
  Contract.fromJson(
    PoolContractJson,
    "=34-2=1-3+e=2-1+7e=1+206=331-1+5=203-1+c=40+7a7e0214696e73657274206174206d617020706174683a2000=151-1+3=178+7a7e021472656d6f7665206174206d617020706174683a2000=30",
    "2db628fec86c0a27c74d106e85b69f72bac32a2d5ac0b79d8ef7970695f5a068",
    []
  )
);
