...
export const Pool = new Factory(
  Contract.fromJson(
    PoolContractJson,
    "=18-2+a2=2-2+ca=2+5=1-1=125-1+9=106+7a7e0214696e73657274206174206d617020706174683a2000=135-1+3=178+7a7e021472656d6f7665206174206d617020706174683a2000=30",
    "0e74d52c33db9a5e60d24c2b73e371c50b0ca85aa25130800f213f9b7de14e8e",
    []
  )
);
